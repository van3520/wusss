...
const quizzes: Quiz[] = [
  {
    ...
    questions: [
      ...
      { question: "Imagine you have a cute money box or a bank account. That’s an example of…", options: ["Hiding money in your shoes", "Saving money wisely", "Spending money super fast", "Giving money away to strangers"], correct: 1, explanation: "Using a cute money box or bank account is a smart way to save." },
