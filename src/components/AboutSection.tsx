...
const AboutSection = () => {
  const socials = [
    {
      name: "Instagram 📸",
      description: "Kepo dikit boleh lah, follow kami buat konten seru!",
      icon: FaInstagram,
      link: "https://www.instagram.com/finance_one_club?utm_source=qr&igsh=MWZ6anVkZzl2NjA4Zw==",
      gradient: "from-pink-400 via-pink-500 to-pink-600",
      animate: "animate-bounce",
    },
    {
      name: "YouTube 🎬",
      description: "Tonton video gokil & edukatif, jangan lupa like & subscribe!",
      icon: FaYoutube,
    ...
    {
      name: "TikTok 🎵",
      description: "Tips keuangan singkat, seru, dan ga ngebosenin!",
      icon: FaTiktok,
      link: "https://www.tiktok.com/@financeoneclub?_t=ZS-8zn3pxKDztK&_r=1",
  ...
  return (
    <section className="relative py-20 bg-gradient-to-b from-green-50 via-pink-50 to-white overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center">
        {/* Hero Image */}
        <motion.div
          className="mx-auto mb-10 max-w-sm relative rounded-3xl overflow-hidden shadow-2xl"
        ...
        >
          ...
          <p className="text-xl md:text-2xl leading-relaxed text-gray-800">
            WUSS is an application inspired by the needs of{" "}
            <span className="font-semibold text-green-700">kids our age</span>, especially in our community, who have already started saving.{" "}
            <span className="block mt-4">
              It aims to support their <span className="font-bold text-pink-500">financial knowledge</span> so that their motivation to save increases and they can secure a successful future through <span className="font-bold text-green-700">financial literacy</span>.
            </span>
          </p>
        </motion.div>
